...
MONTH = 12
HUNDRED =  100
monthly_interest_rate = (annual_interest_rate/HUNDRED)/MONTH
duration_in_months = duration*MONTH
one_plus_rate= 1 + monthly_interest_rate

numerator_calculation = monthly_interest_rate*(one_plus_rate**duration_in_months)

denominator_calculation = (one_plus_rate ** duration_in_months) -1

monthly_payment = principal*(numerator_calculation / denominator_calculation)
